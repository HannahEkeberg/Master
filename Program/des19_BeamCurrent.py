...
#x = myclass.current_for_CS(return_energies=True)
#print(x)
"""
...
def run_varmin(files, names, compartment, makePlot=False):
    ...
    if type(names) == str:
        ...
        for i in range(n):
            ...
            WE_Ni, chi, I_est, dI_est = myclass.variance_minimization(compartment, names[i], MakePlot=False)
...
#run_varmin(files, names, 7, makePlot=False)
